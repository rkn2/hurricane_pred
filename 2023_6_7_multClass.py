...
import requests
#get data
url = 'https://pennstateoffice365-my.sharepoint.com/:x:/g/personal/rjn5308_psu_edu/ETYGsmiZUKZAmekbgPn-kfkB_RLF49Z3jEIQheyW30OV9Q?e=2Zpkm3&download=1'
r = requests.get(url)
r.status_code
...
automl = AutoML(
    results_path='2023_6_7_multi-class',
